...
//		}
	...
	//I used the following code to generate a few extra files which I needed for testing, but which cannot be generated by the VM yet.
	//I left it here rather than deleting it because maybe it will be useful to someone else somehow if one day they need to
	//generate annotations that aren't available in the VM.
	/*
